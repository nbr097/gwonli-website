        ...
        <div class="lg:grid lg:grid-cols-12 lg:auto-rows-min lg:gap-x-8">
            <div class="lg:col-start-8 lg:col-span-5">
                <div class="flex justify-between">
                    <h1 class="text-3xl font-medium text-grey-300 dark:text-white overflow-hidden">Official Gwonli Bag</h1>
                    </div>
                    <div class="pt-4">
                    <p class="text-xl font-medium text-grey-300 dark:text-white">$50.00</p>
                </div>
            </div>
                ...
                <div id="carouselindicators" class="carousel slide relative" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner relative w-full overflow-hidden rounded-xl">
                        <div class="carousel-item active float-left w-full">
                            <img src="https://github.com/nbr097/gwonli/blob/main/images/merch/bags/Bag2.jpg?raw=true" class="block w-full"
                                alt="Bag" />
                        </div>
                    </div>
                </div>
