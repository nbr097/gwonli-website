<section style="min-height: 50vh;" class="select-none">
	<div id="carouselCaptions" class="carousel carousel-fade carousel-dark slide relative"
		data-bs-ride="carousel">
		<div class="carousel-inner relative w-full overflow-hidden">
			<div class="carousel-item active relative float-left w-full">
				<img src="https://github.com/nbr097/gwonli/blob/main/images/background/bg1.jpg?raw=true"
					class="block w-full object-cover max-h-screen min-h-screen" alt="..." />
				<div
					...
					<div class="box h-min w-max text-white text-right mx-auto text-lg md:-mt-0 -mt-32 md:pt-0">
						<p class="">
							Victory comes from finding<br />opportunities in the problem<br />- Sun Tzu
						</p>
						<br />
						<p>Do not pray for an easy<br />life, pray for the courage,<br />to endure a difficult one.
							<br /> - Bruce Lee</p>
					</div>
				</div>
			</div>
			<div class="carousel-item relative float-left w-full">
				<img src="https://github.com/nbr097/gwonli/blob/main/images/background/bg2.jpg?raw=true"
					class="block w-full object-cover max-h-screen min-h-screen" alt="..." />
				<div
					...
					<div class="box w-max text-white -mt-28 md:-mt-0 md:text-right text-center mx-auto text-2xl pl-0 md:pl-7 pt-0 md:pt-0">
						<p class="">
							Learning defence improves the<br /> attack. if the lion knows how the <br /> can escape,
							it'll capture it<br /> in a more precise way.<br />-R. Grace
						</p>
					</div>
				</div>
			</div>
			<div class="carousel-item relative float-left w-full">
				<img src="https://github.com/nbr097/gwonli/blob/main/images/background/bg4.jpg?raw=true"
					class="block w-full object-cover max-h-screen min-h-screen" alt="..." />
			<div
					class="grid grid-cols-1 grid-rows-2 md:grid-cols-3 md:grid-rows-1 gap-0 grid-flow-row h-max w-max absolute text-white items-center m-auto left-0 right-0 top-0 bottom-0 overflow-hidden">
					<div
					...
					<div class="box w-max text-white -mt-28 md:-mt-0 text-center md:text-right mx-auto text-2xl pt-0 md:pt-0">
						<p class="">
							in the struggle between<br/>the stone and water,<br/> in time, the water wins.<br/>- Japanese Proverb
						</p>
					</div>
				</div>
			</div>
