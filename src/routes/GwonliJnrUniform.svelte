        ...
        <div class="lg:grid lg:grid-cols-12 lg:auto-rows-min lg:gap-x-8">
            <div class="lg:col-start-8 lg:col-span-5">
                <div class="flex justify-between">
                    <h1 class="text-3xl font-medium text-grey-300 dark:text-white overflow-hidden">Official Gwonli Jnr. Uniform</h1>
                    </div>
                    <div class="pt-4">
                    <p class="text-xl font-medium text-grey-300 dark:text-white">$25.00</p>
                </div>
            </div>
                ...
                <div id="carouselindicators" class="carousel slide relative" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner relative w-full overflow-hidden rounded-xl">
                        <div class="carousel-item active float-left w-full">
                            <img src="https://github.com/nbr097/gwonli/blob/main/images/merch/uniform/KidsPlain.jpg?raw=true" class="block w-full"
                                alt="Front Uniform" />
                        </div>
                    </div>
            ...
            <div class="mt-8 lg:col-span-5">
                ...
                <div class="mt-10">
                    ...
                    <div class="mt-4 prose prose-sm text-gray-500 dark:text-white">
                        <p>The Official Gwonli Jnr. Uniform is locally made using only the best materials to ensure they can cope with the rigerious excerises our students are put through while learning martial arts.</p>
                    </div>
                </div>
                ...
                <form>
                    <a href="mailto:merch@gwonli.com?subject=Order%20Enquiry%20-%20Gwonli%20Jnr.%20Uniform&body=Hi%2C%0D%0A%0D%0AI%20would%20like%20to%20order%20(1)x%20Gwonli%20Jnr.%20Uniform(s)%20for%20STUDENT%20NAME%0D%0A%0D%0AKind%20regards%2C%0D%0A">
            ...
            <div class="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                ...
                <div class="group relative">
                    ...
                    <div class="mt-4 flex justify-between">
                        ...
                        <p class="text-sm font-medium text-grey-300 dark:text-white">$120</p>
                    </div>
                </div>
